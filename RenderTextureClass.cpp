...
bool RenderTextureClass::Initialize(ID3D11Device* device,
    ...
    m_projectionMatrix = XMMatrixPerspectiveFovLH((3.141592654f / 4.0f),
        (static_cast <float> (textureWidth) / static_cast <float> (textureHeight)), screenNear, screenDepth);

    m_orthoMatrix = XMMatrixOrthographicLH(static_cast <float> (textureWidth),
        static_cast <float> (textureHeight), screenNear, screenDepth);
