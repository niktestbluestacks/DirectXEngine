...
bool TranslateShaderClass::Initialize(ID3D11Device* device, HWND hwnd) {
    ...
    error = wcscpy_s(vsFilename, 128, L"../DirectXEngine/translatevs.hlsl");
    if (error != 0) {
        return false;
    }

    error = wcscpy_s(psFilename, 128, L"../DirectXEngine/translateps.hlsl");
    if (error != 0) {
        return false;
    }
...
bool TranslateShaderClass::InitializeShader(ID3D11Device * device, HWND hwnd, WCHAR * vsFilename, WCHAR * psFilename) {
    ...
    result = D3DCompileFromFile(vsFilename, nullptr, nullptr, "TranslateVertexShader", "vs_5_0", D3D10_SHADER_ENABLE_STRICTNESS, 0,
    ...
    result = D3DCompileFromFile(psFilename, nullptr, nullptr, "TranslatePixelShader", "ps_5_0", D3D10_SHADER_ENABLE_STRICTNESS, 0,
