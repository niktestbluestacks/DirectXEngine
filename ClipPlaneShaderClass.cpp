...
bool ClipPlaneShaderClass::Initialize(ID3D11Device* device, HWND hwnd) {
    ...
    error = wcscpy_s(vsFilename, 128, L"../DirectXEngine/clipplanevs.hlsl");
    if (error != 0) {
        return false;
    }

    error = wcscpy_s(psFilename, 128, L"../DirectXEngine/clipplaneps.hlsl");
    if (error != 0) {
        return false;
    }
...
bool ClipPlaneShaderClass::InitializeShader(ID3D11Device* device, HWND hwnd, WCHAR* vsFilename, WCHAR* psFilename) {
    ...
    result = D3DCompileFromFile(vsFilename, nullptr, nullptr, "ClipPlaneVertexShader", "vs_5_0", D3D10_SHADER_ENABLE_STRICTNESS, 0,
    ...
    result = D3DCompileFromFile(psFilename, nullptr, nullptr, "ClipPlanePixelShader", "ps_5_0", D3D10_SHADER_ENABLE_STRICTNESS, 0,
